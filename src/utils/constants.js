...
export const WINDOW_SIZE_M = 769;
export const WINDOW_SIZE_S = 481;
export const NUMBER_OF_CARDS_L = 12;
export const NUMBER_OF_CARDS_M = 8;
export const NUMBER_OF_CARDS_S = 5;
export const MORE_CARDS_S = 4;
export const MORE_CARDS_XS = 2;
